...
public class AdjacencyListGraph<E> implements GraphADT<E>
{
   ...
   protected Map<Vertex<E>,Set<Edge<E>>> adjacencyLists;
   ...
   {  // add all the vertices to this graph and keep track of the
      ...
      Map<Vertex<F>,Vertex<E>> correspondence
      ...
      for (Edge<F> oldEdge : graph.edgeSet())
   ...
   protected class AdjacencyListVertex implements Vertex<E>
   {
      ...
      {  Set<Vertex<E>> vertices = new HashSet<Vertex<E>>();
         for (Edge<E> edge : adjacencyLists.get(this))
